...
class ExpiredBasicToken(Exception):
    """
    Exists only to say that the basic token used to gen the bearer doesn't work
    """
    pass
...
class Queue:
    ...
    def __init__(self, stored_class_type: type = None, source_url: str = None, tag_only_mode: str = None):
        ...
        """
        # todo maybe make this inherit from list to give more functionality via __*__
    ...
    def load(self, limit: int = None, paging_start: str = None):
        ...
        """
        if limit == 0:
            # dumb stuff may possible here without the check
            return
